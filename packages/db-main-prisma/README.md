...
Basic demo of a shared package using [prisma](<(https://prisma.io)>) to handle database access, part of the [compare-package-managers](https://github.com/belgattitude/compare-package-managers)
